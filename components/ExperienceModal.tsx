...
type Props = {
    ...
    onClose: () => void;
    isEditMode: boolean;
    item: any; // selectedItem ou objet vide {}
  ...
  const ExperienceModal = ({
    ...
    // Update draft when item changes (e.g. when user hits "Modifier")
    React.useEffect(() => {
        setItemDraft(item || {});
    }, [item]);
    ...
    const handleChange = (field: string, value: string) => {
      ...
      onChange(updated); // informe le parent si besoin
    };
          ...
          <View style={[styles.modalContent, { width: '90%' }]}>
            ...
            {showCalendar && (
              <Calendar
                ...
                markedDates={{
                  [itemDraft.date]: { selected: true, selectedColor: '#00cc66' },
                }}
